...
class Args:
    ...
    # Set to 14 when evaluating a dual-arm 14-D model (OXE_Mix pretrained).
    # The right-arm slice [7:14] will be extracted before unnormalization.
    # Default 7 is backward-compatible with 7-D single-arm models.
...
def eval_libero(args: Args) -> None:
    ...
    with open(pathlib.Path(args.output_dir) / f"{args.task_suite_name}.json", "w") as stream:
