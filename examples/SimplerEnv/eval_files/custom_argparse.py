...
def get_args():
    ...
    parser.add_argument(
        ...
        default=14,
        choices=[7, 14],
        help="Action output dimension of the policy. Use 14 for dual-arm 14-D models "
        "(OXE_Mix pretrained); the right-arm slice [7:14] is automatically extracted "
        "before unnormalization. Default: 7 (single-arm, backward compatible).",
    )
